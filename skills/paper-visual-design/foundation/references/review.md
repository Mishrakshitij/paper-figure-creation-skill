...
## Art direction and hybrid figures

Ask what the reader notices first, what visibly changes, and whether illustrative detail helps them follow the scientific relationship. Compare revisions at the same size and source scope; a richer scene can still be a worse explanation. For hybrid exports, identify generated/observed imagery, verify the same asset and crop identities across panels, preserve live text and exact vector connections, and inspect a rasterized final PDF. Check that a teaching illustration or symbolic prediction cannot be mistaken for observed evidence. See [art-direction.md](art-direction.md) and [hybrid-authoring.md](hybrid-authoring.md).
