...
| Experimental plot or multi-panel result figure | Compare methods, budgets, trends, or ablations with sourced values at actual paper size | [graphs-spec.md](references/graphs-spec.md), [evidence.md](references/evidence.md), [layout-and-overflow.md](references/layout-and-overflow.md) |
